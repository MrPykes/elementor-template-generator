...
function createContainer(children = [], settings = {}, isInner = false){
  return {
    ...
    settings: Object.assign({
      ...
      padding_tablet_extra: { unit: 'px', top: '50', right: '30', bottom: '50', left: '30', isLinked: false },
      padding_mobile_extra: { unit: 'px', top: '30', right: '20', bottom: '30', left: '20', isLinked: false },
...
function headingWidget(text, level){
  ...
  return createWidget('heading', {
    ...
    typography_font_size_mobile: { unit: 'px', size: Math.max(14, Math.floor(fontSize * 0.6)), sizes: [] },
    typography_font_weight: '600',
    align_mobile: 'left',
    __globals__: { title_color: 'globals/colors?id=192489f' },
    _element_width: 'initial'
  });
}
...
function buttonWidget(text, href){
  ...
  return createWidget('ucaddon_creative_buttons', {
    ...
    button_border_color: '#B9F22F',
    button_border_hover_color: '#B9F22F',
    button_typography_typography: 'custom',
    button_typography_font_family: 'Poppins',
    button_typography_font_size: { unit: 'px', size: 18, sizes: [] },
    _css_classes: 'sty-btn',
    animation_duration: 'fast',
    _animation_delay: 200,
    __globals__: { background: 'globals/colors?id=02c58a1', button_text_color: 'globals/colors?id=8c3e8ed' }
  });
}
